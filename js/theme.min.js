(() => {
  // ns-hugo:D:\CodeSoftware\MyBlogData\HugoWebSite\MyBlog\zyzhi-blog\themes\FixIt\assets\js\util.js
  var Util = class {
  ...
  var FixIt = class {
    ...
    getSiteTime = () => {
      ...
      $runTimes.innerHTML = `${days}\u5929 ${String(hours).padStart(2, 0)}\u5C0F\u65F6${String(minutes).padStart(2, 0)}\u5206\u949F${String(seconds).padStart(2, 0)}\u79D2`;
